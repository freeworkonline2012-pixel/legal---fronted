      ...
      <div className="mx-auto flex h-16 w-full max-w-[1200px] items-center justify-between gap-4 px-4 sm:px-8">
        ...
        <nav aria-label="التنقل الرئيسي" className="flex items-center gap-1 sm:gap-2">
          {/* ترتيب القائمة (أُعيد ترتيبه بالكامل 2026-09-05 بطلب صريح):
              ...
              الأدلة الإرشادية - تدقيق العقود - الحوكمة والالتزام - [تبديل الوضع] -
              جرّب مجاناً (أو البريد/خروج عند وجود جلسة).
              تحديث لاحق (نفس اليوم 2026-09-05، بطلب صريح): "تسجيل الدخول"
              و"اشترك" أُخفيا من القائمة العلوية (راجع التعليقات عند كل منهما
              أدناه لتفاصيل كل قرار) — بقيت "جرّب مجاناً" فقط من مجموعة الحساب.
              زر تبديل الوضع الليلى ليس رابط تنقل بل أداة مساعدة دائمة، فأُبقى
              فى موضعه المنطقى المعتاد — بعد آخر رابط محتوى وقبل مجموعة الحساب. */}
          <Link
            href="/chat"
          ...
          {/* أُضيف 2026-09-05: أول واجهة أمامية لخدمة الحوكمة (Service 3) —
              كانت API فقط بلا أى صفحة (Phase 3 مؤجَّلة). الرابط ظاهر عمداً بنفس
              شكل باقى القائمة (لا "تجريبي" فى نص الرابط نفسه) لأن الصفحة نفسها
              تحمل تنبيهاً دائماً بارزاً غير قابل للطى، وهذا أنسب مكان لذلك
              التحذير من ازدحام نص القائمة العلوية — راجع تعليق GovernanceScreen
              للتفاصيل. نص الرابط عُدِّل 2026-09-07 من "تحقق الالتزام" إلى
              "الحوكمة والالتزام" بطلب صريح ليعكس نطاق الخدمة (حوكمة + التزام،
              لا التزام فقط). */}
          <Link
            href="/governance"
            className="hidden min-h-[44px] items-center rounded-md px-3 text-body-sm text-text-secondary hover:bg-surface-muted hover:text-text-primary focus-visible:outline-none md:inline-flex"
          ...
          {showAuth ? (
            authed ? (
              ...
              // إخفاء زر "تسجيل الدخول" من القائمة العلوية بطلب صريح
              // 2026-09-05 (نفس اليوم الذى فُعِّل فيه ظهوره فى كل الصفحات) —
              // الإبقاء على "جرّب مجاناً" فقط، وهو يشير أصلاً إلى نفس صفحة
              // الدخول (/login?mode=signup) فلا يفقد المستخدم القدرة على
              // تسجيل الدخول من هنا. صفحة /login تبقى تعمل بالوصول المباشر
              // ومن أى رابط آخر يشير إليها (مثل بطاقات "سجّل الدخول أولاً").
              <div className="hidden items-center gap-2 sm:flex">
          ...
          {/* إخفاء رابط "اشترك" من القائمة العلوية بطلب صريح 2026-09-05 —
              صفحة /pricing نفسها لم تُحذف وتبقى تعمل عبر الرابط المباشر،
              أُزيلت من التنقل الرئيسى فقط (نفس نمط «أسئلتي»/«الخطط» أعلاه). */}
        </nav>
      </div>
    </header>
  );
